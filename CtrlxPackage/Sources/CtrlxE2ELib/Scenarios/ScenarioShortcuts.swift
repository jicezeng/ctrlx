...
public enum Shortcut {
    ...
    /// TestStep.macResizeWindow(width: 1_200, height: 700)
    /// ```
    public static let macOnlySetup = CtrlxE2ELib.scenario(
        "Mac-Only Setup",
        tags: ["shortcut"]
    ) {
    ...
    /// ```
    public static let twoMacPairing = CtrlxE2ELib.scenario(
    ...
    public static let addMacViewer = CtrlxE2ELib.scenario(
        "Add Mac Viewer",
        tags: ["shortcut"]
    ) {
