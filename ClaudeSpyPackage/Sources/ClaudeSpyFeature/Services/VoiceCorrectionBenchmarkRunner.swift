...
enum VoiceCorrectionBenchmark {
    ...
    ## main...origin/main [ahead 1]
     M ClaudeSpyPackage/Sources/ClaudeSpyFeature/Models/VoiceRecognitionResult.swift
     M ClaudeSpyPackage/Sources/ClaudeSpyFeature/Services/VoiceTranscriptCorrector.swift
     M ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/VoiceInputButton.swift
    ...
    developer@mac ctrlx % rg -n 'Voice Input|VoiceInputButton' ClaudeSpyPackage/Sources
    ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/VoiceInputButton.swift:561: .accessibilityLabel("Voice Input")
    ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/VoiceInputButton.swift:679: struct TerminalVoiceInputButton: View {
    ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/TerminalKeyboardBar.swift:94: Text("Voice")
    developer@mac ctrlx % swift test --package-path ClaudeSpyPackage --filter VoiceInputTextComposerTests
    ...
    developer@mac ctrlx % sed -n '535,710p' ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/VoiceInputButton.swift
    ...
    developer@mac ctrlx % xcodebuild -project ClaudeSpy.xcodeproj -scheme ClaudeSpy -configuration Debug -destination 'generic/platform=iOS' -skipMacroValidation build
    ...
    ** BUILD SUCCEEDED **
    ...
    developer@mac ctrlx % rg -n 'recommendedModelIDs' ClaudeSpyPackage/Sources/ClaudeSpyFeature
    ...
    developer@mac ctrlx % sed -n '20,52p' ClaudeSpyPackage/Sources/ClaudeSpyFeature/Services/VoiceCorrectionProviderClient.swift
    case .volcengineArk:
        [
            "deepseek-v4-pro-ga-260813",
            "doubao-seed-2-0-lite-260215",
    ...
    developer@mac ctrlx % swift test --package-path ClaudeSpyPackage --filter VoiceCorrectionProviderClientTests
    Building for debugging...
    ...
    developer@mac ctrlx % rg -n 'Voice Input' ClaudeSpyPackage/Sources/ClaudeSpyFeature
    Views/TerminalKeyboardBar.swift:94: Text("Voice")
    Views/VoiceInputButton.swift:561: .accessibilityLabel("Voice Input")
    developer@mac ctrlx % rg -n '2.0 Pro|model test' docs ClaudeSpyPackage/Sources/ClaudeSpyFeature | head
    ClaudeSpyPackage/Sources/ClaudeSpyFeature/Views/VoiceCorrectionSettingsSection.swift:72: Label("Test Provider Models", systemImage: "gauge.with.dots.needle.50percent")
    ClaudeSpyPackage/Sources/ClaudeSpyFeature/Models/VoiceCorrectionSettingsModel.swift:118: statusMessage = "Testing provider models"
    developer@mac ctrlx %
    """
